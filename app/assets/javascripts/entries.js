...
$(document).ready(function() {
    if ($('#entries_linechart').length) {
        $.getScript('https://www.google.com/jsapi', function() {
            var accountConsolidatedEntries = $('#entries_linechart').data('consolidated-entries');
            var accountName = $('#entries_linechart').data('account-name');
            var categoryNames = $('#entries_linechart').data('category-names');
            ...
            google.load("visualization", "1", {packages:["corechart"], "callback": 
                function drawChart() {
                    ...
                    var chart = new google.visualization.LineChart(document.getElementById('entries_linechart'));
